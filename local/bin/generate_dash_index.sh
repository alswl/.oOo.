...
ls $HOME/Library/Application\ Support/Dash/DocSets/AngularJS/AngularJS.docset/Contents/Resources/Documents/angularjs/code.angularjs.org/1.4.7/docs.html | sed "s/\\/Users\\/$WHOAMI\\/Library\\/Application Support\\/Dash\\///g" >> "$TEMP_INDEX_PATH"

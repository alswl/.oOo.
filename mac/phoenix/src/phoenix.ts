...
// Key.on('r', config.MASH, () => callApp('/Applications/iDingTalk.app/Contents/Frameworks/Tblive.app'));
Key.on('r', config.MASH, () => callApp('/Applications/Antding.app/Contents/Frameworks/DingMeeting.app/Contents/MacOS/DingMeeting'));

...
export { MAC_SCREEN_IN_THE_RIGHT, MASH, MASH_SHIFT, MASH_CTRL, MOUSE_POSITIONS, HIDE_INACTIVE_WINDOW_TIME, ACTIVE_WINDOWS_TIMES, DEFAULT_WIDTH, WORK_SPACE_INDEX_MAP, SECOND_WORK_SPACE_INDEX_MAP, PARK_SPACE_APP_INDEX_MAP, A_BIG_PIXEL };
